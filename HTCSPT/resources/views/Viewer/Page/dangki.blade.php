...
<!-- /fonts -->
<!-- css -->
<link href="assets/asset/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all" />
<link href="assets/asset/css/style.css" rel='stylesheet' type='text/css' media="all" />
<!-- /css -->
</head>
<div class="content-w3ls">	
	<div class="content-agile2">
		<form action="#" method="post">
			<div class="form-control1 w3layouts"> 
			...
			<div class="form-control1 agileinfo">	
