<footer class="ftco-footer ftco-bg-dark ftco-section">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">CSPT</h2>
                    <p>Uy tín - tiện lợi - đơn giản.</p>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">Minh khai - Bắc Từ Liêm -
                                    Hà Nội</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span
                                        class="text">0382544996</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span
                                        class="text">dungpt2805@gmail.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center" style="margin-left: 142px;">
                ...
                <p>
                    ...
                    </script> Thuetro247.com
                    <span>
                        All rights reserved | Nhóm 2-KTPM1 <i class="icon-heart color-danger" aria-hidden="true"></i> Môn Phát Triển Phần Mềm Hướng Dịch Vụ
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
               
                </span>
                <span>Hà Văn Tú - Phạm Thị Dung - Nguyễn Tiến Thành</span>
                </p>
            </div>
        </div>
    </div>
