                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> Thống Kê <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Thống kê người dùng</a></li>
                      <li><a href="index2.html">Thống kê báo lỗi</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-table"></i> Danh Sách<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">Người Dùng</a></li>
                      <li><a href="tables_dynamic.html">Phòng Trọ</a></li>
                    </ul>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">Hà Tú
