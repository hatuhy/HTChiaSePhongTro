            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="statistic-block block">
                        <div class="progress-details d-flex align-items-end justify-content-between">
                            <div class="title">
                                <div class="icon"><i class="icon-user-1"></i></div><strong>Thành Viên Còn Hoạt Động</strong>
                            </div>
                            <div class="number dashtext-1">{{$sondchd}}</div>
                        </div>
                        <div class="progress progress-template">
                           <!--  <div role="progressbar" style="width:($tilend)%" aria-valuenow="$sondchd" aria-valuemin="$sondchd"
                                aria-valuemax="$sond" class="progress-bar progress-bar-template dashbg-1"></div> -->
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="statistic-block block">
                        <div class="progress-details d-flex align-items-end justify-content-between">
                            <div class="title">
                                <div class="icon"><i class="icon-contract"></i></div><strong>Bài Đăng Chưa Kiểm Duyệt</strong>
                            </div>
                            <div class="number dashtext-2">{{$soptcdk}}</div>
                        </div>
                        <div class="progress progress-template">
                            <!-- <div role="progressbar" style="width: $soptcdk/$sopt" aria-valuenow="$sopt" aria-valuemin="{{$soptcdk}}"
                                aria-valuemax="{{$sopt}}" class="progress-bar progress-bar-template dashbg-2"></div> -->
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="statistic-block block">
                        <div class="progress-details d-flex align-items-end justify-content-between">
                            <div class="title">
                                <div class="icon"><i class="icon-paper-and-pencil"></i></div><strong>Báo Cáo</strong>
                            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="statistic-block block">
                        <div class="progress-details d-flex align-items-end justify-content-between">
                            <div class="title">
                                <div class="icon"><i class="icon-writing-whiteboard"></i></div><strong>Blogs</strong>
                            </div>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="assets_admin/asset/img/avatar-1.jpg" alt="..." class="img-fluid">
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="assets_admin/asset/img/avatar-4.jpg" alt="..." class="img-fluid">
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="assets_admin/asset/img/avatar-6.jpg" alt="..." class="img-fluid">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="assets_admin/asset/img/avatar-1.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
                </div>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="assets_admin/asset/img/avatar-2.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Alexander Shelby</strong><span class="d-block">@alexshelby</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="assets_admin/asset/img/avatar-6.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Arther Kooper</strong><span class="d-block">@artherkooper</span></a>
                </div>
                <div class="col-lg-4 text-center">
              ...
              <div class="col-lg-6">                                           
                <div class="messages-block block">
                  ...
                  <div class="messages"><a href="#" class="message d-flex align-items-center">
                      <div class="profile"><img src="assets_admin/asset/img/avatar-3.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="assets_admin/asset/img/avatar-2.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="assets_admin/asset/img/avatar-1.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="assets_admin/asset/img/avatar-5.jpg" alt="..." class="img-fluid">
